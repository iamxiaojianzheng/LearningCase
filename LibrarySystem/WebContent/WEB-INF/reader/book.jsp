		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					<li class="active"><a
						href="${pageContext.request.contextPath}/bookAction_findBookByPage.action"><i
							class="glyphicon glyphicon-chevron-right"></i> 图书查询</a></li>
					<s:if test="#session.reader!=null">
						<!-- 判断是否登录 -->
						<li><a
							href="${pageContext.request.contextPath}/reader/borrowAction_findMyBorrowInfoByPage.action"><i
					...
					<s:if test="#session.reader!=null">
						<!-- 判断是否登录 -->
						<li><a
							href="${pageContext.request.contextPath}/reader/forfeitAction_findMyForfeitInfoByPage.action"><i
								class="glyphicon glyphicon-chevron-right"></i> 逾期信息</a></li>
					</s:if>
						...
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal"
									action="${pageContext.request.contextPath}/bookAction_queryBook.action"
									method="post">
									<div class="col-lg-5 form-group">
										<label class="col-lg-4 control-label" for="query_bno">图书ISBN号</label>
										<div class="col-lg-8">
											<input class="form-control" id="bookId" name="ISBN"
									...
									<div class="col-lg-5 form-group">
										...
										<div class="col-lg-8">
											<input class="form-control" id="autho" name="autho"
												type="text" value=""> <label class="control-label"
												for="query_bname2" style="display: none;"></label>
										</div>
									</div>
									...
									<tbody>
										...
										<td>
											<button type="button" class="btn btn-info btn-xs"
												...
												onclick="getBookInfo(<s:property value="#book.bookId"/>)">查看</button>
										</td>
									</tbody>
								</s:iterator>
							</s:if>
						...
						<s:if test="#request.pb!=null">
							...
							<div class="pull-right">
								...
								<ul class="pagination">
									...
									<li><a
										href="${pageContext.request.contextPath}/bookAction_${pb.url }pageCode=1">首页</a></li>
									<li><a
										href="${pageContext.request.contextPath}/bookAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a></li>
									<!-- 上一页 -->
									<%-- 循环显示页码列表 --%>
									<c:forEach begin="${begin }" end="${end }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="${pageContext.request.contextPath}/bookAction_${pb.url }pageCode=${i}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${pb.pageCode < pb.totaPage }">
										<li><a
											href="${pageContext.request.contextPath}/bookAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a></li>
									</c:if>
									<%--否则显示尾页 --%>
									<li><a
										href="${pageContext.request.contextPath}/bookAction_${pb.url }pageCode=${pb.totaPage}">尾页</a></li>
								</ul>
							</div>
						</s:if>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="findModalLabel">查看图书信息</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findISBN"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findBookName"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findBookType"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findAutho"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findPress"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findNum"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findCurrentNum"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="findPrice"
									readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<textarea class="form-control" rows="3" id="findDescription"
