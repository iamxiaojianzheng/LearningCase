...
<script
	src="${pageContext.request.contextPath}/js/updateAuthorization.js"></script>
</head>
									...
									<div class="col-lg-5 form-group">
										...
										<div class="col-lg-8">
											<input class="form-control" type="text" id="adminUserName"
												name="adminUserName"> <label class="control-label"
												for="adminUserName" style="display: none;"></label>
										</div>
									</div>
									<div class="col-lg-5 form-group">
										...
										<div class="col-lg-8">
											<input class="form-control" type="text" id="adminName"
												name="adminName"> <label class="control-label"
												for="adminName" style="display: none;"></label>
										</div>
									</div>
							...
							<s:if test="#request.pb.beanList!=null">
								<s:iterator value="#request.pb.beanList" var="admin">
									<tbody>
										...
										<td><s:if test="#admin.authorization.superSet!=1">
												<button type="button" class="btn btn-warning btn-xs"
													data-toggle="modal" data-target="#updateModal"
													onclick="updateAdmin(<s:property value="#admin.aid"/>)">修改</button>
												<button type="button" class="btn btn-danger btn-xs"
													onclick="deleteAdmin(<s:property value="#admin.aid"/>)">删除</button>
												<button type="button" class="btn btn-success btn-xs"
													data-toggle="modal" data-target="#powerModal"
													onclick="power(<s:property value="#admin.aid"/>)">权限</button>
											</s:if> <s:else>
	                                	  			超级管理员
	                                	    </s:else></td>
									</tbody>
						...
						<s:if test="#request.pb!=null">
							...
							<div class="pull-right">
								...
								<ul class="pagination">
									...
									<li><a
										href="${pageContext.request.contextPath}/admin/adminManageAction_${pb.url }pageCode=1">首页</a></li>
									<li><a
										href="${pageContext.request.contextPath}/admin/adminManageAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a></li>
									<!-- 上一页 -->
									<%-- 循环显示页码列表 --%>
									<c:forEach begin="${begin }" end="${end }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="${pageContext.request.contextPath}/admin/adminManageAction_${pb.url }pageCode=${i}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${pb.pageCode < pb.totaPage }">
										<li><a
											href="${pageContext.request.contextPath}/admin/adminManageAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a></li>
									</c:if>
									<%--否则显示尾页 --%>
									<li><a
										href="${pageContext.request.contextPath}/admin/adminManageAction_${pb.url }pageCode=${pb.totaPage}">尾页</a></li>
								</ul>
							</div>
						</s:if>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addUsername"
									placeholder="请输入管理员用户名"> <label class="control-label"
									for="addUsername" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addName"
									placeholder="请输入管理员真实姓名"> <label class="control-label"
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addPhone"
									placeholder="请输入管理员联系电话"> <label class="control-label"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">用户名</label>
							<div class="col-sm-7">
								<input type="hidden" id="updateId"> <input type="text"
									class="form-control" id="updateUsername"> <label
									class="control-label" for="updateUsername"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="powerModalLabel">设置管理员权限</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="hidden" id="aid"> <input type="checkbox"
									name="power" id="typeSet" value="typeSet">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="checkbox" name="power" id="readerSet"
									value="readerSet">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="checkbox" name="power" id="borrowSet"
									value="borrowSet">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="checkbox" name="power" id="forfeitSet"
									value="forfeitSet">
							</div>
						</div>
						<div class="form-group">
